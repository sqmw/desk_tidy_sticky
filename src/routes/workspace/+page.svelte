...
<style>
  ...
  .workspace {
    --ws-text-strong: #101828;
    --ws-text: #3a4557;
    --ws-muted: #71809b;
    --ws-accent: #2563eb;
    --ws-panel-bg: rgba(252, 253, 255, 0.85);
    --ws-card-bg: #ffffff;
    --ws-btn-bg: #ffffff;
    --ws-btn-hover: #f2f5fb;
    --ws-btn-active: linear-gradient(180deg, #eef2fa 0%, #e5ebf5 100%);
    --ws-badge-bg: #e9f0ff;
    --ws-badge-border: #d6e4ff;
    --ws-border: #e3e9f2;
    --ws-border-soft: #e7ecf5;
    --ws-border-hover: #cdd9ea;
    --ws-border-active: #94a3b8;
    --ws-shadow-color: rgba(15, 23, 42, 0.07);
    ...
    --ws-input-bg: #ffffff;
    --ws-input-border: #dfe6f0;
    --ws-input-text: #101828;
    --ws-workspace-bg:
      radial-gradient(1100px 500px at 10% -6%, rgba(37, 99, 235, 0.055), transparent 62%),
      radial-gradient(900px 460px at 98% 106%, rgba(249, 115, 22, 0.045), transparent 60%),
      linear-gradient(180deg, #f6f8fc 0%, #f1f4fa 100%);
    /* Structural tokens: not theme-preset controlled, shared by every workspace surface. */
    --ws-radius-sm: 8px;
    --ws-radius-md: 12px;
    --ws-radius-lg: 16px;
    --ws-shadow-sm: 0 1px 2px var(--ws-shadow-color, rgba(15, 23, 42, 0.06));
    --ws-shadow-md: 0 10px 28px var(--ws-shadow-color, rgba(15, 23, 42, 0.08));
    --ws-shadow-lg: 0 20px 48px var(--ws-shadow-color, rgba(15, 23, 42, 0.12));
    --ws-focus-ring: 0 0 0 3px color-mix(in srgb, var(--ws-accent, #2563eb) 16%, transparent);
  ...
  /* Theme tokens are injected as inline style from theme-presets.js
     (buildWorkspaceThemeVarStyle); do not duplicate preset values here. */
  ...
  .workspace :global(.toolbar .add-input) {
    min-height: calc(34px * var(--ws-layout-scale, 1));
  }
