...
export function normalizePomodoroConfig(input) {
  ...
  return {
    ...
    taskStartReminderLeadMinutes: clamp(
      raw.taskStartReminderLeadMinutes,
      DEFAULT_POMODORO.taskStartReminderLeadMinutes,
      1,
      60,
    ),
...
export async function loadWorkspacePreferences(invoke) {
  ...
  const pomodoroConfig = normalizePomodoroConfig({
    ...
    taskStartReminderEnabled: prefs.pomodoroTaskStartReminderEnabled,
    taskStartReminderLeadMinutes: prefs.pomodoroTaskStartReminderLeadMinutes,
    ...
    breakReminderMode: prefs.pomodoroBreakReminderMode,
