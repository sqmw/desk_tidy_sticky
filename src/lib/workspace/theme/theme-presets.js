...
const WORKSPACE_THEME_PRESETS = [
  {
    ...
    vars: {
      ...
      "--ws-workspace-bg":
        "radial-gradient(1100px 500px at 10% -6%, rgba(37, 99, 235, 0.055), transparent 62%), radial-gradient(900px 460px at 98% 106%, rgba(249, 115, 22, 0.045), transparent 60%), linear-gradient(180deg, #f6f8fc 0%, #f1f4fa 100%)",
    },
  },
  {
    id: "dark",
    ...
    vars: {
      "--ws-text-strong": "#eef2f9",
      "--ws-text": "#c3cddd",
      "--ws-muted": "#8b99b0",
      "--ws-accent": "#7aa2ff",
      "--ws-panel-bg": "rgba(15, 21, 34, 0.86)",
      "--ws-card-bg": "#161f31",
      "--ws-btn-bg": "#1b2539",
      "--ws-btn-hover": "#243352",
      ...
      "--ws-shadow-color": "rgba(2, 6, 16, 0.5)",
      "--ws-scrollbar-track": "rgba(148, 163, 184, 0.14)",
      ...
      "--ws-workspace-bg":
        "radial-gradient(1100px 500px at 10% -6%, rgba(96, 145, 255, 0.08), transparent 62%), radial-gradient(900px 460px at 98% 106%, rgba(251, 146, 60, 0.06), transparent 60%), linear-gradient(180deg, #0c1322 0%, #0e1626 100%)",
    },
  },
  {
    id: "paper",
    ...
    vars: {
      ...
      "--ws-shadow-color": "rgba(87, 66, 24, 0.09)",
  ...
  },
  {
    ...
    vars: {
      ...
      "--ws-shadow-color": "rgba(1, 12, 8, 0.5)",
  ...
  },
  {
    ...
    vars: {
      ...
      "--ws-shadow-color": "rgba(88, 28, 108, 0.1)",
...
export function buildWorkspaceThemeVarStyle(value) {
  ...
  if (!("--ws-shadow-color" in preset.vars)) {
    lines.push(`--ws-shadow-color: rgba(15, 23, 42, 0.08);`);
  }
  return lines.join(" ");
}
