...
> 2026-03-27 状态：块编辑器 MVP 已暂停推进并退役。当前请以 `docs/ui/2026-03-27-note-editor-single-document-reset.md` 为准。
...
## 2026-03-27 退役结论
1. `BlockEditor.svelte` 与相关块模型/操作/光标工具已删除。
2. 贴纸页与工作台详情页统一回到单文档编辑器。
3. 如后续重新推进块级方案，需要基于新的产品边界重新立项，而不是恢复当前历史实现。
