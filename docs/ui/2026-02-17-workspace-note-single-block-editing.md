...
> 2026-03-27 状态：本文对应的单块编辑方案已退役。当前工作台详情页已回归单文档编辑，请以 `docs/ui/2026-03-27-note-editor-single-document-reset.md` 为准。
...
## 2026-03-27 退役结论
1. 工作台详情编辑不再复用 `BlockEditor`。
2. 当前问题域从“单块编辑体验”收敛为“稳定的整文档编辑”。
3. `contenteditable` 路径与相关光标补丁一并退役。
