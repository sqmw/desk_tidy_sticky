...
> 2026-03-27 状态：本文中的块编辑相关拆分已转入历史记录。当前生效方案请以 `docs/ui/2026-03-27-note-editor-single-document-reset.md` 为准。
...
## 2026-03-27 当前结论
1. `SourceEditorPane.svelte` 保留并成为统一的单文档编辑器。
2. 块模型与 `contenteditable` 相关治理代码已整体退役。
3. 后续编辑器治理重点从“块级能力扩张”转为“整文档编辑稳定性、保存链路与渲染一致性”。
