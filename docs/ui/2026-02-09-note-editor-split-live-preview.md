...
> 2026-03-27 状态：本文描述的 `blocks/source` 双模式已退役。当前请以 `docs/ui/2026-03-27-note-editor-single-document-reset.md` 为准。
...
## 2026-03-27 退役结论
1. 块级编辑暂停推进。
2. 当前完整笔记页与工作台详情页统一为单文档编辑。
3. `src/lib/note/editor-display-mode.js` 已删除，不再保留块/源码双模式切换。
