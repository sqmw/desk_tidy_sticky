...
- [Timetable Schema v2 and Real Demo](plugins/timetable-schema-v2.md): current data contract, actual course demo, source/uncertainty preservation, v1 compatibility and reminder safety.
