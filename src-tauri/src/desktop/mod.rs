...
pub(crate) use sticky::{
    ...
    apply_window_no_snap_by_label, get_overlay_interaction, move_note_window_without_activation,
    pin_window_to_desktop, sync_all_note_window_layers, sync_note_window_layer,
