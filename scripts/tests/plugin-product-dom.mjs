...
fs.writeFileSync(path.join(root, 'main.js'), `import {mount} from 'svelte';import App from '${path.join(repo, 'src/routes/plugins/+page.svelte')}';mount(App,{target:document.getElementById('app')});`);
